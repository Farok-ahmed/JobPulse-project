    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{route('home')}}" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{asset('backend/assets')}}/images/logo-sm.svg" alt="" height="24"> <span class="logo-txt">JobPulse</span>
                    </span>
                </a>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{route('company.profile')}}"><i class="mdi mdi-face-profile font-size-16 align-middle me-1"></i> Profile</a>
