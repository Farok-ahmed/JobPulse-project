                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="{{route('home')}}" class="d-block auth-logo">
                                            <img src="{{asset('backend/assets/')}}/images/logo-sm.svg" alt="" height="28"> <span class="logo-txt">JobPulse</span>
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            <h5 class="mb-0">Register Account</h5>
                                            <p class="text-muted mt-2">Get your free JobPulse account now.</p>
                                        </div>
                                        <form class="needs-validation mt-4 pt-2" method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="form-floating form-floating-custom mb-4">
                                                <input type="text" name="name" class="form-control" id="input-username" placeholder="Enter User Name" required>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="mb-4">
                                                <p class="mb-0">By registering you agree to the JobPulse <a href="#" class="text-primary">Terms of
                                                        Use</a>
                                                </p>
                                            </div>
                                            <div class="mb-3">
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> JobPulse   . Crafted with <i class="mdi mdi-heart text-danger"></i> by Themesbrand</p>
                                    </div>
                                </div>
                            </div>
                        </div>
