                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mt-2">Sign in to continue to JobPulse.</p>
                                        </div>
                                        ...
                                        <form class="needs-validation mt-4 pt-2" method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="mb-4">
                                                <p class="mb-0"><a href="{{route('password.email')}}" class="text-primary">Forgot your password?</a>
                                                </p>
                                            </div>
                                            <div class="mb-3">
